class AddIndexToForeignKeys < ActiveRecord::Migration
  ...
  def self.down
    ...
    remove_index :comments, 'comments_commentable_id_commentable_type_ix'
    ...
    remove_index :likes, 'likes_likeable_id_likeable_type_ix'
    ...
    remove_index :episodes, 'episodes_series_id_ix'
  end
end
